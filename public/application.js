...
/***/ function(module, exports, __webpack_require__) {
	...
	var gamesEvents = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetIndex = function onGetIndex(event) {

	  // stops page from refreshing
	  event.preventDefault();
	  api.getIndex().then(ui.success).catch(ui.failure);
	};

	// used for claculating the number of games a user has created
	var totalGames = function totalGames(event) {

	  // stops page from refreshing
	  event.preventDefault();
	  api.getIndex().then(function (response) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var update = function update(id, index, user, checkWinner) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	function checkEachIndex() {
	  return gameBoard.every(function (e) {
	    return e !== '';
	  });
	}
	...
	var upDateBoards = function upDateBoards(event) {
	...
	var onCreateGame = function onCreateGame() {
	  ...
	  api.create().then(function (response) {
	    ...
	    return response;
	  }).then(ui.createSuccess).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.signOutSuccess).catch(ui.error);
	};
